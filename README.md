...
This will produce `target/Litterbox-1.4.jar`
...
```
java -jar Litterbox-1.4.jar --help
```
...
```
java -jar Litterbox-1.4.jar --check --path <path/to/project.json>
```
...
```
java -jar Litterbox-1.4.jar --check --projectid <projectid> --path <path/to/store/downloaded/project>
```
...
```
java -jar Litterbox-1.4.jar --check --projectlist <path/to/projectidlist.txt> --path <path/to/projects>
```
...
```
java -jar Litterbox-1.4.jar --check --path <path/to/project.json> --output <result.csv>
```
...
```
java -jar Litterbox-1.4.jar --check --path <path/to/project.json> --annotate <result.json>
```
...
```
java -jar Litterbox-1.4.jar --check --path <path/to/project.json> --detectors endless_recursion,call_without_definition
```
...
```
java -jar Litterbox-1.4.jar --stats --project <path/to/project.json> --output <statsfile.csv>
```
