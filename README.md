...
This will produce `target/Litterbox-1.9.1.full.jar`
...
```bash
java -jar Litterbox-1.9.1.full.jar --help
```
...
```bash
java -jar Litterbox-1.9.1.full.jar check --path <path/to/project.json>
```
...
```bash
java -jar Litterbox-1.9.1.full.jar check --project-id <project-id> --path <path/to/store/downloaded/project>
```
...
```bash
java -jar Litterbox-1.9.1.full.jar check --project-list <path/to/projectidlist.txt> --path <path/to/projects>
```
...
```bash
java -jar Litterbox-1.9.1.full.jar check --path <path/to/project.json> --output <result.csv>
```
...
```bash
java -jar Litterbox-1.9.1.full.jar check --path <path/to/project.json> --annotate <results/>
```
...
```bash
java -jar Litterbox-1.9.1.full.jar \
    check \
...
```bash
java -jar Litterbox-1.9.1.full.jar check \
    --path <path/to/project.json> \
    --output <result.csv> \
