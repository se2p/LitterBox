...
public abstract class ChangeCoordinateByBlock extends SingleIntInputBlock {
    ...
    public ChangeCoordinateByBlock(String opcode, Stackable next, Extendable parent, Boolean shadow, Boolean topLevel, Integer inputType, String inputName, String inputID, Integer inputShadow) {
        super(opcode, next, parent, shadow, topLevel, inputType, inputName, inputID, inputShadow);
    }

    public ChangeCoordinateByBlock(String opcode, Stackable next, Extendable parent, Boolean shadow, Boolean topLevel, Integer x, Integer y, Integer inputType, String inputName, String inputID, Integer inputShadow) {
