...
public class IfBlock extends CBlock implements Extendable, Stackable {

    private Slot slot; //Slot into which an input can be inserted
    private Stackable next;

    public IfBlock(String opcode, String id, Boolean shadow, Boolean topLevel) {
        super(opcode, id, shadow, topLevel);
    }

    public IfBlock(String opcode, String id, Boolean shadow, Boolean topLevel, Integer x, Integer y) {
