...
public class GyroPitchAngle extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public GyroPitchAngle(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_gyro_pitch_angle;
    }
}
