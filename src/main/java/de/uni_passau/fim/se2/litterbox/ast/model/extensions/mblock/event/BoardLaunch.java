...
public class BoardLaunch extends AbstractNode implements MBlockEvent, ASTLeaf {
    private final BlockMetadata metadata;

    public BoardLaunch(BlockMetadata metadata) {
        super(metadata);
    ...
    public Opcode getOpcode() {
        return EventOpcode.when_board_launch;
    }
}
