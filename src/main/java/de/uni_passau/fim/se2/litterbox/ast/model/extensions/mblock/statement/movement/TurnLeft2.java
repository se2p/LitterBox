...
public class TurnLeft2 extends AbstractNode implements RobotMoveStmt, LongStmt {

    private final NumExpr degree;
    private final BlockMetadata metadata;

    public TurnLeft2(NumExpr degree, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return RobotMoveStmtOpcode.move_left_with_angle;
    }
}
