...
public class TokenVisitor
    ...
    private TokenVisitor(final ProcedureDefinitionNameMapping procedureNameMapping, boolean abstractTokens) {
    ...
    public static List<String> tokenize(final Program program, final ASTNode node, boolean abstractTokens) {
        return tokenize(program.getProcedureMapping(), node, abstractTokens);
    }
    ...
    private static List<String> tokenize(
        ...
        final TokenVisitor v = new TokenVisitor(procedureNameMapping, abstractTokens);
        node.accept(v);
        return v.tokens;
    }
    ...
    public void visit(CallStmt node) {
        if (abstractTokens) {
            ...
            tokens.add(AstNodeUtil.replaceProcedureParams(fullProcedureName, ""));
        }
    ...
    public void visit(ProcedureDefinition node) {
        ...
        if (abstractTokens) {
            ...
            tokens.add(AstNodeUtil.replaceProcedureParams(fullName, ""));
        }
    ...
    public void visit(NumberLiteral node) {
        ifAbstractElse(AbstractToken.LITERAL_NUMBER, Double.toString(node.getValue()));
    }

    @Override
    public void visit(StringLiteral node) {
        ifAbstractElse(AbstractToken.LITERAL_STRING, node.getText());
    }

    @Override
    public void visit(BoolLiteral node) {
        ifAbstractElse(AbstractToken.LITERAL_BOOL, Boolean.toString(node.getValue()));
    }

    @Override
    public void visit(ColorLiteral node) {
        ifAbstractElse(AbstractToken.LITERAL_COLOR, node.getRGB());
    }
    ...
    public void visit(StrId node) {
        ifAbstractElse(AbstractToken.NODE_IDENTIFIER, node.getName());
    }
    ...
    public void visit(Variable node) {
        ifAbstractElse(AbstractToken.VAR, node.getName().getName());
    }
    ...
    public void visit(ScratchList node) {
        ifAbstractElse(AbstractToken.LIST, node.getName().getName());
    }
    ...
    public void visit(FixedNote node) {
        ifAbstractElse(Token.MUSIC_LITERAL_NOTE, Double.toString(node.getNote()));
    }
    ...
    private void visitFixedNodeOption(final FixedNodeOption option, final Token opcode) {
        if (abstractTokens) {
            ...
            visit(option, option.getTypeName());
        }
    }
