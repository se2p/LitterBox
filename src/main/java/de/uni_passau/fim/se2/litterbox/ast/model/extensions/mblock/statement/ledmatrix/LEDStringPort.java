...
public class LEDStringPort extends AbstractNode implements LEDMatrixStmt, PortStmt {

    private final MCorePort port;
    private final StringExpr text;
    private final BlockMetadata metadata;

    public LEDStringPort(MCorePort port, StringExpr text, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_text;
    }
}
