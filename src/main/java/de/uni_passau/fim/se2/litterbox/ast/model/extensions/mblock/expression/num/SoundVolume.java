...
public class SoundVolume extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public SoundVolume(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_volume;
    }
}
