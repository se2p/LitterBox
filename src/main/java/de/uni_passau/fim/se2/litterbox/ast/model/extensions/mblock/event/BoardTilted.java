...
public class BoardTilted extends AbstractNode implements MBlockEvent {

    private final RobotDirection direction;
    private final BlockMetadata metadata;

    public BoardTilted(RobotDirection direction, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return EventOpcode.when_board_tilt;
    }
}
