...
public class SpeakerVolume extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public SpeakerVolume(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_sound_volume;
    }
}
