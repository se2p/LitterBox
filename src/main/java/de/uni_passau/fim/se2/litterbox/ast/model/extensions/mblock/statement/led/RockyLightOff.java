...
public class RockyLightOff extends AbstractNode implements LEDStmt, RockyLightStmt, ASTLeaf {

    private final BlockMetadata metadata;

    public RockyLightOff(BlockMetadata metadata) {
        super(metadata);
    ...
    public Opcode getOpcode() {
        return LEDStmtOpcode.rocky_turn_off_led_color;
    }
}
