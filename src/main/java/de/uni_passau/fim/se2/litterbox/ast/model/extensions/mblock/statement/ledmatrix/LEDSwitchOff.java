...
public class LEDSwitchOff extends AbstractNode implements LEDMatrixStmt {

    private final NumExpr xAxis;
    private final NumExpr yAxis;
    private final BlockMetadata metadata;

    public LEDSwitchOff(NumExpr xAxis, NumExpr yAxis, BlockMetadata metadata) {
        super(xAxis, yAxis, metadata);
        this.xAxis = xAxis;
        this.yAxis = yAxis;
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.light_off_led_matrix_position;
    }
}
