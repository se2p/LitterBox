...
public class PlaySound extends AbstractNode implements SpeakerStmt {

    private final SoundList soundList;
    private final BlockMetadata metadata;

    public PlaySound(SoundList soundList, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return SpeakerStmtOpcode.show_play_sound;
    }
}
