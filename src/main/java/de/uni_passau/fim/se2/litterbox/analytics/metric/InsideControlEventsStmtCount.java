...
public class InsideControlEventsStmtCount<T extends ASTNode> implements MetricExtractor<T>, ScratchVisitor {
    public static final String NAME = "inside_control_events_stmt_count";
    private int count = 0;
