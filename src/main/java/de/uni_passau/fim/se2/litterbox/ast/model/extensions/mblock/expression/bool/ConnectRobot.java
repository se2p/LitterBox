...
public class ConnectRobot extends SingularExpression implements MBlockBoolExpr, ASTLeaf {

    public ConnectRobot(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return BoolExprOpcode.event_connect_rocky;
    }
}
