...
public class AmbientLight extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public AmbientLight(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_lightness;
    }
}
