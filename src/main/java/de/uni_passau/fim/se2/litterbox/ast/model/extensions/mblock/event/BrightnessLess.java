...
public class BrightnessLess extends AbstractNode implements MBlockEvent {

    private final NumExpr value;
    private final BlockMetadata metadata;

    public BrightnessLess(NumExpr value, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return EventOpcode.when_brightness_less;
    }
}
