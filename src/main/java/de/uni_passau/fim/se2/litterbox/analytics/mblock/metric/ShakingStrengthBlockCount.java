...
public class ShakingStrengthBlockCount<T extends ASTNode> implements MetricExtractor<T>, MBlockVisitor {
    public static final String NAME = "shaking_strength_block_count";
    private int count = 0;
