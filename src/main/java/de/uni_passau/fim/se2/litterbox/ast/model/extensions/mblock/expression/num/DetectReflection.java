...
public class DetectReflection extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public DetectReflection(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.rocky_detect_reflection;
    }
}
