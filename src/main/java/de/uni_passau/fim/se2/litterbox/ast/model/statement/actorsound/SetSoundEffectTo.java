...
public class SetSoundEffectTo extends AbstractNode implements ActorSoundStmt {
    private final NumExpr value;
    private final SoundEffect effect;
    private final BlockMetadata metadata;

    public SetSoundEffectTo(SoundEffect effect, NumExpr value, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return ActorSoundStmtOpcode.sound_seteffectto;
    }
}
