...
public class RobotTimer extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public RobotTimer(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_time;
    }
}
