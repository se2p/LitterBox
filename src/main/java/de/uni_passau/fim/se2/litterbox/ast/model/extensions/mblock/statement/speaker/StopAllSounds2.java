...
public class StopAllSounds2 extends AbstractNode implements SpeakerStmt {
    private final BlockMetadata metadata;

    public StopAllSounds2(BlockMetadata metadata) {
        super(metadata);
    ...
    public Opcode getOpcode() {
        return SpeakerStmtOpcode.show_stop_allsound;
    }
}
