...
public class RotateZAngle extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public RotateZAngle(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_rotatez_angle;
    }
}
