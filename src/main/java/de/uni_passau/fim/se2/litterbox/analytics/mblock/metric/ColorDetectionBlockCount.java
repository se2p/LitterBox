...
public class ColorDetectionBlockCount<T extends ASTNode> implements MetricExtractor<T>, MBlockVisitor {
    public static final String NAME = "color_detection_block_count";
    private int count = 0;
