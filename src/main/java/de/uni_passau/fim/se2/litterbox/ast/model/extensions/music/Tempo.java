...
public class Tempo extends SingularExpression implements NumExpr, MusicExpression {

    public Tempo(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.music_getTempo;
    }
}
