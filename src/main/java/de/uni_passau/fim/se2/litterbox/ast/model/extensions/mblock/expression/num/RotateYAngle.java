...
public class RotateYAngle extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public RotateYAngle(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_rotatey_angle;
    }
}
