...
public class LEDSwitchOn extends AbstractNode implements LEDMatrixStmt {

    private final NumExpr xAxis;
    private final NumExpr yAxis;
    private final BlockMetadata metadata;

    public LEDSwitchOn(NumExpr xAxis, NumExpr yAxis, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_led_matrix_position;
    }
}
