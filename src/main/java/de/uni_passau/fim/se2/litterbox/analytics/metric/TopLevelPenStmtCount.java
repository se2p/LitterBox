...
public class TopLevelPenStmtCount<T extends ASTNode> implements MetricExtractor<T>, ScratchVisitor {
    public static final String NAME = "top_level_pen_stmt_count";
    private int count = 0;
