...
public class LEDColorTimedPosition extends AbstractNode implements LEDStmt, TimedStmt, PositionStmt, ColorStmt {
    ...
    public LEDColorTimedPosition(LEDPosition position, StringExpr colorString, NumExpr time, BlockMetadata metadata) {
        super(position, colorString, time, metadata);
    ...
    public Opcode getOpcode() {
        return LEDStmtOpcode.show_led_time;
    }
}
