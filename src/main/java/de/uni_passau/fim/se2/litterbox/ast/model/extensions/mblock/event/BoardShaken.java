...
public class BoardShaken extends AbstractNode implements MBlockEvent, ASTLeaf {
    private final BlockMetadata metadata;

    public BoardShaken(BlockMetadata metadata) {
        super(metadata);
    ...
    public Opcode getOpcode() {
        return EventOpcode.when_board_shake;
    }
}
