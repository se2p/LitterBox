...
public class DetectAmbientLightPort extends UnaryExpression<MCorePort> implements MBlockNumExpr {

    public DetectAmbientLightPort(MCorePort port, BlockMetadata metadata) {
        super(port, metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_external_light;
    }
}
