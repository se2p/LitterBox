...
public class Potentiometer extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public Potentiometer(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_potentiometer;
    }
}
