...
public class DetectLinePort extends UnaryExpression<MCorePort> implements MBlockNumExpr {

    public DetectLinePort(MCorePort port, BlockMetadata metadata) {
        super(port, metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_external_linefollower;
    }
}
