...
public class KeepForwardTimed extends AbstractNode implements RobotMoveStmt, TimedStmt, SinglePower {

    private final NumExpr percent;
    private final NumExpr time;
    private final BlockMetadata metadata;

    public KeepForwardTimed(NumExpr percent, NumExpr time, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return RobotMoveStmtOpcode.rocky_keep_absolute_forward;
    }
}
