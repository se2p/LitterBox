...
import de.uni_passau.fim.se2.litterbox.ast.model.extensions.mblock.option.IRRemoteButton;
...
public class IRButtonPressed extends UnaryExpression<IRRemoteButton> implements MBlockBoolExpr {

    public IRButtonPressed(IRRemoteButton operand, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return BoolExprOpcode.event_ir_remote;
    }
}
