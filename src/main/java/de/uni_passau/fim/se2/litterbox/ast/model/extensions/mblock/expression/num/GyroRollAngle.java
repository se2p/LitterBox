...
public class GyroRollAngle extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public GyroRollAngle(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_gyro_roll_angle;
    }
}
