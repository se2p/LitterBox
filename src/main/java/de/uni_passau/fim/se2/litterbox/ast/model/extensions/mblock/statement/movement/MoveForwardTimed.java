...
public class MoveForwardTimed extends AbstractNode implements RobotMoveStmt, TimedStmt, SinglePower {

    private final NumExpr percent;
    private final NumExpr time;
    private final BlockMetadata metadata;

    public MoveForwardTimed(NumExpr percent, NumExpr time, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return RobotMoveStmtOpcode.move_forward_with_time;
    }
}
