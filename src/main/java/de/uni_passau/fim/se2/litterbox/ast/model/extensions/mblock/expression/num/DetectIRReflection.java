...
public class DetectIRReflection extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public DetectIRReflection(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.rocky_detect_ir_reflection;
    }
}
