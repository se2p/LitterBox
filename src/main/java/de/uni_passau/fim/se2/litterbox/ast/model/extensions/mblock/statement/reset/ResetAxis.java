 ...
 */
package de.uni_passau.fim.se2.litterbox.ast.model.extensions.mblock.statement.reset;
...
public class ResetAxis extends AbstractNode implements ResetStmt {

    private final RobotAxis axis;
    private final BlockMetadata metadata;

    public ResetAxis(RobotAxis axis, BlockMetadata metadata) {
        super(axis, metadata);
        this.axis = axis;
        this.metadata = metadata;
    }

    public RobotAxis getAxis() {
        return axis;
    }
    ...
    public Opcode getOpcode() {
        return ResetStmtOpcode.reset_angle;
    }
}
