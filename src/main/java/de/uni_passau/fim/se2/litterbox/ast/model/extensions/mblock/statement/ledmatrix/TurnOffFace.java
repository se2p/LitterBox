...
public class TurnOffFace extends AbstractNode implements LEDMatrixStmt, ASTLeaf {
    private final BlockMetadata metadata;

    public TurnOffFace(BlockMetadata metadata) {
        super(metadata);
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_led_matrix_turn_off;
    }
}
