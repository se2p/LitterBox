...
public class TopLevelSoundStmtCount<T extends ASTNode> implements MetricExtractor<T>, ScratchVisitor {
    public static final String NAME = "top_level_sound_stmt_count";
    private int count = 0;
