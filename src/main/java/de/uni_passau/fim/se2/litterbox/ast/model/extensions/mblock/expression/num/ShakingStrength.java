...
public class ShakingStrength extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public ShakingStrength(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_shaked_strength;
    }
}
