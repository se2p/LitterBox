...
/**
 * The GuardedMessageOrStop pattern means inside a loop a certain condition is checked (if-statement). If the condition
 * is met, a stop-block or a broadcast is triggered.
 */
public class GuardedMessageOrStop extends AbstractIssueFinder {

    public static final String NAME = "guarded_message_or_stop";
