...
public class RobotButtonPressed extends UnaryExpression<RobotButton> implements MBlockBoolExpr {

    public RobotButtonPressed(RobotButton operand, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return BoolExprOpcode.event_button_pressed;
    }
}
