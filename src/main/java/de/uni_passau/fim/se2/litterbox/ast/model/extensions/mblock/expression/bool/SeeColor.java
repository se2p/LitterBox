...
public class SeeColor extends UnaryExpression<LEDColor> implements MBlockBoolExpr {

    public SeeColor(LEDColor operand, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return BoolExprOpcode.event_is_color;
    }
}
