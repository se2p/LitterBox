...
public class LEDStringPositionPort extends AbstractNode implements LEDMatrixStmt, PortStmt {
    ...
    public LEDStringPositionPort(MCorePort port, StringExpr text, NumExpr xAxis, NumExpr yAxis, BlockMetadata metadata) {
        super(port, text, metadata);
        this.port = port;
        this.text = text;
        this.xAxis = xAxis;
        this.yAxis = yAxis;
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_text_position;
    }
}
