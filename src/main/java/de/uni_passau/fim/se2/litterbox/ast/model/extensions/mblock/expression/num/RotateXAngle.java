...
public class RotateXAngle extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public RotateXAngle(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.detect_rotatex_angle;
    }
}
