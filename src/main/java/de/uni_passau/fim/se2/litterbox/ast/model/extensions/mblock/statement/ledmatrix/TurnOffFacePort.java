...
public class TurnOffFacePort extends AbstractNode implements LEDMatrixStmt, PortStmt, ASTLeaf {

    private final MCorePort port;
    private final BlockMetadata metadata;

    public TurnOffFacePort(MCorePort port, BlockMetadata metadata) {
        super(port, metadata);
        this.port = port;
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_face_off;
    }
}
