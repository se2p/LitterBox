...
public class Direction extends SingularExpression implements NumExpr, ASTLeaf {
    public Direction(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.motion_direction;
    }
}
