...
public class LEDStringScrolling extends AbstractNode implements LEDMatrixStmt, LongStmt {

    private final StringExpr text;
    private final BlockMetadata metadata;

    public LEDStringScrolling(StringExpr text, BlockMetadata metadata) {
        super(text, metadata);
        this.text = text;
    ...
    public Opcode getOpcode() {
        return LEDMatrixStmtOpcode.show_led_matrix_string;
    }
}
