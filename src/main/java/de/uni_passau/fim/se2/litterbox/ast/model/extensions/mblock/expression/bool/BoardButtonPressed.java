...
public class BoardButtonPressed extends UnaryExpression<PressedState> implements MBlockBoolExpr {

    public BoardButtonPressed(PressedState operand, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return BoolExprOpcode.event_board_button_pressed;
    }
}
