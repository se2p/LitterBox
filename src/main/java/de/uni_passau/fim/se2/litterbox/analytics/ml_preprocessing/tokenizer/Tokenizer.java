...
public class Tokenizer
    ...
    private Tokenizer(final ProcedureDefinitionNameMapping procedureNameMapping, boolean abstractTokens) {
    ...
    private static List<String> tokenize(
        ...
        final Tokenizer v = new Tokenizer(procedureNameMapping, abstractTokens);
        node.accept(v);
        return v.tokens;
    }
