...
public class MoveBackwardTimed extends AbstractNode implements RobotMoveStmt, TimedStmt, SinglePower {

    private final NumExpr percent;
    private final NumExpr time;
    private final BlockMetadata metadata;

    public MoveBackwardTimed(NumExpr percent, NumExpr time, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return RobotMoveStmtOpcode.move_backward_with_time;
    }
}
