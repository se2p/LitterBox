...
public class DetectRGBValue extends UnaryExpression<RGB> implements MBlockNumExpr, ASTLeaf {

    public DetectRGBValue(RGB rgbColor, BlockMetadata metadata) {
        super(rgbColor, metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.rocky_detect_rgb;
    }
}
