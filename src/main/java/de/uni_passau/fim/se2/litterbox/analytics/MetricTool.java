...
public class MetricTool {
    ...
    private List<MetricExtractor> metrics = Arrays.asList(
            ...
            new InsideControlControlStmtCount<Program>(),
            new InsideControlEventsStmtCount<Program>(),
            new InsideControlLooksStmtCount<Program>(),
            new InsideControlMotionStmtCount<Program>(),
            new InsideControlMyBlocksStmtCount<Program>(),
            new InsideControlPenStmtCount<Program>(),
            new InsideControlSensingStmtCount<Program>(),
            new InsideControlSoundStmtCount<Program>(),
            new InsideControlVariablesStmtCount<Program>(),
            ...
            new TopLevelControlStmtCount<Program>(),
            new TopLevelEventsStmtCount<Program>(),
            new TopLevelLooksStmtCount<Program>(),
            new TopLevelMotionStmtCount<Program>(),
            new TopLevelMyBlocksStmtCount<Program>(),
            new TopLevelPenStmtCount<Program>(),
            new TopLevelSensingStmtCount<Program>(),
            new TopLevelSoundStmtCount<Program>(),
            new TopLevelVariablesStmtCount<Program>(),
