...
public class MetricTool {
    ...
    private List<MetricExtractor> metrics = Arrays.asList(
            ...
            new InsideControlMotionStmtCount(),
            new InsideControlMyBlocksStmtCount(),
            new InsideControlPenStmtCount(),
            new InsideControlSensingStmtCount(),
            new InsideControlSoundStmtCount(),
            new InsideControlVariablesStmtCount(),
            new LengthLongestScript(),
            new LooksBlockCount(),
            new MostComplexScript(),
            ...
            new SpriteCount(),
            new StatementCount(),
            new TopLevelControlStmtCount(),
            new TopLevelEventsStmtCount(),
            new TopLevelLooksStmtCount(),
            new TopLevelMotionStmtCount(),
            new TopLevelMyBlocksStmtCount(),
            new TopLevelPenStmtCount(),
            new TopLevelSensingStmtCount(),
            new TopLevelSoundStmtCount(),
            new TopLevelVariablesStmtCount(),
