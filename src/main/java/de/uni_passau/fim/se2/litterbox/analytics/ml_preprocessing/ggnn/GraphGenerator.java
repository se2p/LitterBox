...
public class GraphGenerator {
    ...
    public GraphGenerator(Program program, boolean isStageIncluded, boolean isWholeProgram, boolean isDotStringGraph,
                          String labelName) {
    ...
    private String generateGraphsPerSprite(ASTNode sprite, String spriteName, int spriteIndex, String inputPath) {
        ...
        if (isDotStringGraph) {
            ...
            int leafCount = leafsMap.keySet().size();
            return visitor1.printGraph(inputPath, cfg, spriteName, incorrectSpriteName, spriteIndex, leafCount);
        }
    }
