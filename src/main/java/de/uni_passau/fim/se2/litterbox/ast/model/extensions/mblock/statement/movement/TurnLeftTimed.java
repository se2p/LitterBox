...
public class TurnLeftTimed extends AbstractNode implements RobotMoveStmt, TimedStmt, SinglePower {

    private final NumExpr percent;
    private final NumExpr time;
    private final BlockMetadata metadata;

    public TurnLeftTimed(NumExpr percent, NumExpr time, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return RobotMoveStmtOpcode.move_left_with_time;
    }
}
