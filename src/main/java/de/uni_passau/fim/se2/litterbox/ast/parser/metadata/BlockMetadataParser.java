...
public class BlockMetadataParser {
    public static BlockMetadata parse(String blockId, JsonNode blockNode) throws ParsingException {
        if (blockNode.has(OPCODE_KEY)) {
            ...
            if (!topLevel) {
                return new NonDataBlockMetadata(commentId, blockId, opcode, inputMetadata, fields,
                        topLevel,
                        shadow,
                        mutation);
            }
            ...
            return new TopNonDataBlockMetadata(commentId, blockId, opcode, inputMetadata, fields,
                    topLevel,
                    shadow,
                    mutation, x, y);
        } else {
