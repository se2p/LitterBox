...
public class RestForBeats extends AbstractNode implements MusicStmt {
    private final NumExpr beats;
    private final BlockMetadata metadata;

    public RestForBeats(NumExpr tempo, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return MusicOpcode.music_restForBeats;
    }
}
