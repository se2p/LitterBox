...
public class SetTempoTo extends AbstractNode implements MusicStmt {
    private final NumExpr tempo;
    private final BlockMetadata metadata;

    public SetTempoTo(NumExpr beats, BlockMetadata metadata) {
        super(beats, metadata);
        this.tempo = beats;
    ...
    public Opcode getOpcode() {
        return MusicOpcode.music_setTempo;
    }
}
