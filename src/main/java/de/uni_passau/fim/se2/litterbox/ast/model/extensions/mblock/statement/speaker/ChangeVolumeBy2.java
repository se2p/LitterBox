...
public class ChangeVolumeBy2 extends AbstractNode implements SpeakerStmt {
    private final NumExpr volumeValue;
    private final BlockMetadata metadata;

    public ChangeVolumeBy2(NumExpr volumeValue, BlockMetadata metadata) {
    ...
    public Opcode getOpcode() {
        return SpeakerStmtOpcode.show_change_volume;
    }
}
