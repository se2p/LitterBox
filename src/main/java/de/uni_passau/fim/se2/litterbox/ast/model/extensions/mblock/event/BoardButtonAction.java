...
public class BoardButtonAction extends AbstractNode implements MBlockEvent {

    private final PressedState pressed;
    private final BlockMetadata metadata;

    public BoardButtonAction(PressedState pressed, BlockMetadata metadata) {
        super(pressed, metadata);
        this.pressed = pressed;
        this.metadata = metadata;
    }

    public PressedState getPressed() {
        return pressed;
    }
