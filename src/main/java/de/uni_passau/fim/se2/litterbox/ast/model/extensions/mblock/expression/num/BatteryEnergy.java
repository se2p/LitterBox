...
public class BatteryEnergy extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public BatteryEnergy(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.dump_energy;
    }
}
