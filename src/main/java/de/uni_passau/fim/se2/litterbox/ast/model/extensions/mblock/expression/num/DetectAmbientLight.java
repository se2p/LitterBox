...
public class DetectAmbientLight extends SingularExpression implements MBlockNumExpr, ASTLeaf {

    public DetectAmbientLight(BlockMetadata metadata) {
        super(metadata);
    }
    ...
    public Opcode getOpcode() {
        return NumExprOpcode.rocky_detect_lightness;
    }
}
