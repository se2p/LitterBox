...
class LLMIssuePerfumeExtenderTest implements FinderTest, JsonTest {

    @Test
    void doesNotAddBugsToPrompt() throws ParsingException, IOException {
        ...
        final LLMIssuePerfumeExtender extender = new LLMIssuePerfumeExtender(
    ...
    void addsNewIssue(final String scriptIdPrefix) throws ParsingException, IOException {
        final List<Issue> llmIssues = getLlmIssues("""
                found new perfumes, here is a list in the requested format

                New Finding 3:
                - Finding Description: dummy description
                spanning multiple lines
                Finding Location: Q9fC;l--AafmsUddpSe0
    ...
    void addsNewIssueMissingFindingNumber() throws ParsingException, IOException {
        final List<Issue> llmIssues = getLlmIssues("""
                ...
                New Finding:
                - Finding Description: dummy description
                Finding Location: //Script: Q9fC;l--AafmsUddpSe0
                """);
        assertThat(llmIssues).hasSize(1);
    }
