...
public class SameVariableDifferentSpriteTest implements JsonTest {
    @Test
    ...
    public void testSameVariableDifferentSprite() throws IOException, ParsingException {
        Program variableDifferentSprite = getAST("./src/test/fixtures/bugpattern/variableDifferentSprite.json");
        SameVariableDifferentSprite parameterName = new SameVariableDifferentSprite();
