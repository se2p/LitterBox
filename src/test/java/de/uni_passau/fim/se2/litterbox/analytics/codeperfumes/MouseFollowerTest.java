...
public class MouseFollowerTest implements JsonTest {
    ...
    public void testMouseFollowerTwo() throws IOException, ParsingException {
        assertThatFinderReports(2, new MouseFollower(), "./src/test/fixtures/goodPractice/mouseFollower.json");
    }

    @Test
    public void testMouseFollowerIgnoreWrong() throws IOException, ParsingException {
        assertThatFinderReports(2, new MouseFollower(), "./src/test/fixtures/goodPractice/mouseFollowerOneWrong.json");
    }
}
