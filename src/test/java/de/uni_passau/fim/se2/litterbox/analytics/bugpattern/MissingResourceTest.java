...
public class MissingResourceTest implements JsonTest {
    ...
    public void testMissingResources() throws IOException, ParsingException {
        assertThatFinderReports(3, new MissingResource(), "src/test/fixtures/bugpattern/missingResources.json");
    }

    @Test
    public void testEmpty() throws IOException, ParsingException {
        assertThatFinderReports(0, new MissingResource(), "./src/test/fixtures/emptyProject.json");
    }
}
