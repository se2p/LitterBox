...
public class MayFunctionTest {
    ...
    public void testUnion() {
        ...
        MayFunction<DataflowFact> mayFunction = new MayFunction<>();
        Set<DataflowFact> result = mayFunction.apply(join);
        assertThat(result).containsExactly(fact1, fact2, fact3);
    }
}
