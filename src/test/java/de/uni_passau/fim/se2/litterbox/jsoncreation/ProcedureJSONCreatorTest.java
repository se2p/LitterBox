...
public class ProcedureJSONCreatorTest implements JsonTest {
    ...
    public void testProcedureWithParams() {
        ActorDefinition fig1 = procedure.getActorDefinitionList().getDefinitions().get(1);
        String jsonString = ProcedureJSONCreator.createProcedureJSONString(fig1.getProcedureDefinitionList().getList().getFirst(), fig1.getIdent().getName(), procedure.getSymbolTable(), procedure.getProcedureMapping());
    ...
    public void testProcedureWithStmts() {
        ActorDefinition stage = procedure.getActorDefinitionList().getDefinitions().getFirst();
        String jsonString = ProcedureJSONCreator.createProcedureJSONString(stage.getProcedureDefinitionList().getList().getFirst(), stage.getIdent().getName(), procedure.getSymbolTable(), procedure.getProcedureMapping());
