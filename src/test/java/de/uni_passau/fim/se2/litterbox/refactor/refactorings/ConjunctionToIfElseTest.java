...
import de.uni_passau.fim.se2.litterbox.analytics.refactorings.ConjunctionToIfElseFinder;
...
public class ConjunctionToIfElseTest implements JsonTest {

    @Test
    public void testConjunctionToIfElseFinder() throws ParsingException, IOException {
    ...
    public void testConjunctionToIfElseRefactoring() throws ParsingException, IOException {
        ...
        IfThenStmt ifStatement2 = (IfThenStmt) stmtList.getStatement(1);
