...
public class InsideControlEventsStmtCountTest implements JsonTest {
    ...
    public void testAllLoose() throws IOException, ParsingException {
        ...
        InsideControlEventsStmtCount parameterName = new InsideControlEventsStmtCount();
        Assertions.assertEquals(0, parameterName.calculateMetric(empty));
    }

    @Test
    public void testAll() throws IOException, ParsingException {
        Program empty = getAST("./src/test/fixtures/metrics/allEventsInsideControl.json");
        InsideControlEventsStmtCount parameterName = new InsideControlEventsStmtCount();
